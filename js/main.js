...
function compareSequence(arr, arr2, compareArr, includeArr, iCompare, iInclude){
      ...
      containerGame.children.item(i).addEventListener("click", function () {
        ...
        //   console.log(userArr);//DEBUG
          ...
          containerGame.innerHTML +=
            ...
            compareSequence(pcRandom, userArr, comparePosition, compareInclusive, counter, include);
